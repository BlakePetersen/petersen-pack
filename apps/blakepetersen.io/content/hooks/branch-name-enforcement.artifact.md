...
# ABOUTME: Branch-name enforcement — rejects pushes from branches that don't match the prefix convention.

# ABOUTME: Allowed: feat/, fix/, chore/, docs/, refactor/, test/, perf/, build/, ci/, revert/, gsd/, protected branches.
