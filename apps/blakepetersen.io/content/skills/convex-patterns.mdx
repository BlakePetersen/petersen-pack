...
## Compare artifact-page layouts (Blake review only — delete after pick)

Two isolated views of the companion artifact, each with a different framing. Pick a winner; this section gets removed.

- <a href="/artifacts/skills/convex-patterns" target="_blank" rel="noopener">Variant 1 — Bare viewer</a>: minimal chrome, file render is the page.
- <a href="/install/skills/convex-patterns" target="_blank" rel="noopener">Variant 3 — Install context</a>: `blink apply` is the protagonist, files are supporting context.
...
<a href="/artifacts/skills/convex-patterns" target="_blank" rel="noopener">View full convex/schema.ts →</a>
...
<a href="/artifacts/skills/convex-patterns" target="_blank" rel="noopener">View full convex/tasks.ts →</a>
...
<a href="/artifacts/skills/convex-patterns" target="_blank" rel="noopener">View full convex/http.ts →</a>
...
<a href="/artifacts/skills/convex-patterns" target="_blank" rel="noopener">View the full artifact (schema, http, users, scheduling, file storage) →</a>
