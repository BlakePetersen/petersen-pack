...
# ABOUTME: Popup-driven workflows layered on top of an existing tmux config.

# ABOUTME: Source from ~/.config/tmux/tmux.conf via: source-file ~/.config/tmux/popups.conf
