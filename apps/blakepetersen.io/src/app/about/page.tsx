    ...
    <div className="mx-auto max-w-prose px-4 py-12">
      <section className="mb-12">
        ...
        <div className="space-y-4 font-mono text-lg leading-relaxed">
          <p>
            Blake Petersen &mdash; software engineer focused on developer
            experience and AI-augmented workflows.
          </p>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 font-mono text-lg leading-relaxed">
          <p>
            Why opinionated DX? Because every team reinvents the same linting
            configs, git hooks, and CI pipelines. This site documents one set of
            opinionated choices and makes them instantly applicable via Claude
            Code skills.
          </p>
          <p className="text-muted-foreground">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 font-mono text-lg leading-relaxed">
          <p>
            This site is both documentation and a reference implementation.
            Every practice documented here is applied to this codebase. The
            content pipeline, design system, and automation are all examples of
            the DX patterns described.
          </p>
          <p className="text-muted-foreground">
      ...
      <section>
        ...
        <div className="mt-2 space-y-2 font-mono text-base">
          <div>
            <a
              href="mailto:blake@blakepetersen.io"
