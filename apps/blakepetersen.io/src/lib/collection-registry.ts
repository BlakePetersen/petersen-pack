...
import { getSkills, getHooks, getConfigs, getGuides, getPosts } from './content'
...
const collections: Record<string, CollectionDefinition> = {
  skills: {
    ...
    layout: 'dx',
    indexDescription: n =>
      `Browse ${n} Claude Code skills for AI-first development`,
    showInNav: true,
    showInSitemap: true,
    showInFeed: true,
    href: '/skills',
  ...
  configs: {
    ...
    layout: 'dx',
    indexDescription: n =>
      `Browse ${n} tool configurations for consistent development environments`,
    showInNav: true,
    showInSitemap: true,
    showInFeed: true,
    href: '/configs',
  ...
  guides: {
    ...
    layout: 'dx',
    indexDescription: n =>
      `Browse ${n} development guides for AI-first workflows`,
    showInNav: true,
    showInSitemap: true,
    showInFeed: true,
    href: '/guides',
  ...
  posts: {
    ...
    layout: 'post',
    indexDescription: n =>
      `Browse ${n} blog posts on software engineering and AI-first development`,
    showInNav: true,
    showInSitemap: true,
    showInFeed: true,
    href: '/posts',
